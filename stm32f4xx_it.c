...
//				DMA_MemoryTargetConfig(DMA2_Stream1, (uint32_t) (DCMI_BUF_ADDRESS + 800 * 600), cur_mb);
//		}
//		if (dcim_flag == 1) {
//				//DMA_MemoryTargetConfig(DMA2_Stream1, (uint32_t) (DCMI_BUF_ADDRESS + 640 * 480 * 3 / 2), cur_mb);
//				DMA_MemoryTargetConfig(DMA2_Stream1, (uint32_t) (DCMI_BUF_ADDRESS + 800 * 600 * 3 / 2), cur_mb);
//		}
//		if (dcim_flag == 2) {
...
//				DMA_MemoryTargetConfig(DMA2_Stream1, (uint32_t) (DCMI_BUF_ADDRESS + 800 * 600 / 2), cur_mb);
//		}
//		dcim_flag++;
