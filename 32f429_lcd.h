...
//#define  LCD_LAYER2_PIXEL_WIDTH    LCD_PIXEL_WIDTH
//#define  LCD_LAYER2_PIXEL_HEIGHT   LCD_PIXEL_HEIGHT
...
//#define  LCD_LAYER2_PIXEL_WIDTH    ((uint16_t)640)
//#define  LCD_LAYER2_PIXEL_HEIGHT   ((uint16_t)480)
//#define  LCD_LAYER2_X0    				 ((uint16_t)160)
//#define  LCD_LAYER2_Y0 						 ((uint16_t)0)

#define  LCD_LAYER2_PIXEL_WIDTH    ((uint16_t)320)
#define  LCD_LAYER2_PIXEL_HEIGHT   ((uint16_t)240)
#define  LCD_LAYER2_X0    				 ((uint16_t)100)
#define  LCD_LAYER2_Y0 						 ((uint16_t)10)
